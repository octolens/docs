---
title: Webhooks
description: Send mention notifications to other apps via webhooks
---

You can set up an Octolens webhook to send mention notifications to other apps. Webhooks turn any view in your feed into a real-time data stream.

## How to create a webhook

<Steps>
  <Step title="Choose which view you want to send as a webhook">
    Click **"Enable as notification"** in the top-right of any view.
