...
description: Tips for selecting the right keywords to monitor
---
...
Once you've chosen your keywords, fine-tune them with [Keyword Settings](/quickstart/keyword-settings) or apply account-wide filters with [Global Keyword Settings](/quickstart/global-keyword-settings).
