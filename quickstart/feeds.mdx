...
Filter by source. Options: LinkedIn, Stack Overflow, GitHub, DEV, Reddit, Hacker News, Twitter/X, YouTube, TikTok, Bluesky, Newsletter, and, once you have connected a review page, Trustpilot, App Store, and Google Play. See [Tracked Platforms](/learn/platforms/overview) for what's monitored where.

### Review rating

Keep only reviews with certain star ratings, for example 1 and 2 stars for a negative-reviews feed. Only applies to mentions from [review platforms](/learn/platforms/customer-reviews).
