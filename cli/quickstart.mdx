---
title: "Quickstart"
description: "Your first ten minutes with the octolens CLI — sign up or log in, run your first search, triage a mention, save a feed and read the numbers."
---

{/* AUTHORED page (OCT-1503, rewritten by OCT-1504; signup + search funnel
    OCT-1534) — hand-written in the octolens/octolens repo under
    docs/cli/authored/ and published by `pnpm cli:docs:site`. Every `octolens`
    line below is docs-lint-verified against the live command registry, and
    the contract tables are imported from generated snippets, never restated
    by hand. */}
...
<Steps>
  <Step title="Sign up — or log in">
    ...
    [Signup & the Agents plan](/cli/agents).
  ...
  <Step title="Run your first search">
    ...
    [Signup & the Agents plan](/cli/agents) explains the numbers and the
    upgrade path.
  </Step>
