...
<Note>
Prefer a terminal? The [Octolens CLI](/cli/overview) wraps this API with stable exit codes and a strict `--json` contract — often the fastest path for shell scripts, cron jobs, CI, and AI agents.
</Note>
