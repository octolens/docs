---
title: What is Octolens MCP
description: Connect AI agents to your Octolens social listening data
---

**Octolens MCP** lets AI agents securely access your social listening data. MCP (Model Context Protocol) is a standard that allows AI tools to connect with third-party APIs in a secure, consistent way. In this case, it connects AI tools with Octolens, enabling workflows like:

**Example use cases:** "Using Octolens.."
...
**For programmatic access:** Use the Octolens API instead: [API documentation](/api/api)
